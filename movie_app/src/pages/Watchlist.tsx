...
import { addRating, getWatchList } from "../../api";
...
function Watchlist() {
  ...
  const rateMutateion = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["watchlist"] }); // backend database updated == cached data is old, refetch
    },
    onError: () => {
      console.log("");
    },
