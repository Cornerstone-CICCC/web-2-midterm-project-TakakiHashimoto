...
function Home() {
  ...
  return (
    <div className={isDark ? "bg-balck" : "bg-white"}>
      <div className="fixed inset-0 w-full h-full pointer-events-none z-1 overflow-hidden">
        <LightRays
          raysOrigin="top-center"
          raysColor={isDark ? "#00ffff" : "#f2ff04ff"}
          raysSpeed={0.1}
          lightSpread={0.8}
          rayLength={9}
          followMouse={true}
      ...
      <div className="flex flex-col gap-3 z-2">
        <div
          className={
            isDark
              ? `mx-auto mt-16 flex w-full max-w-screen-2xl flex-col gap-8 px-4 sm:px-6 md:px-10`
              : `mx-auto mt-16 flex w-full max-w-screen-2xl flex-col gap-8 px-4 sm:px-6 md:px-10 text-cyan-900`
          }
        >
          <Searchbar
